...
function displayForecast(response) {
    ...
    forecast.forEach(function (forecastDay, index) {
      if (index < 6) {
        ...
        <img src="https://static.vecteezy.com/system/resources/previews/012/303/017/original/3d-sunny-weather-illustration-png/${forecastDay.condition.icon}.png" width="36px/>
...
function displayTemperature(response) {
    ...
    iconElement.setAttribute(
        "src",
        `https://static.vecteezy.com/system/resources/previews/012/303/017/original/3d-sunny-weather-illustration-png/${response.data.condition.icon}.png`
    );
